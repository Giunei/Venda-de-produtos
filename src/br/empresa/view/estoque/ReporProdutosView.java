...
public class ReporProdutosView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReporProdutosView frame = new ReporProdutosView();
	...
	public ReporProdutosView() {
		...
		JLabel lblNewLabel = new JLabel("Rep\u00F4r Produtos");
		...
		JButton btnSalvar = new JButton("Rep\u00F4r");
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				estoque.adicionarProdutos(indiceProduto, quantidade);
